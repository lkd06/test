		...
		<c:forEach var="dto" items="${lists }">
			<tr style="border-bottom: 1px solid #e8e8e8; height: 50px;">
				...
				<td align="center">
					...
					<input type="button" onclick="javascript:location.href='/project/addPoint.action?phone=${dto.phone }';" class="btn btn-primary py-3 px-4" value="포인트 추가">
					<input type="button" onclick="javascript:location.href='/project/???????.action?phone=${dto.phone }';" class="btn btn-primary py-3 px-4" value="등급 관리">
					<input type="button" onclick="javascript:location.href='/project/signout2.action?phone=${dto.phone }';" class="btn btn-primary py-3 px-4" value="회원 삭제">
				</td>
			</tr>
		</c:forEach>
