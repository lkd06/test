        ...
        <div class="row">
          <div class="col-md-12 text-center">
              ...
              <p>
              	...
              	<a href=".action">이벤트</a>&nbsp;&nbsp;|&nbsp; &nbsp;
              	<a href="https://www.cleanmobile.or.kr/indexs.html">이용전화 파파라치 신고센터</a>&nbsp;&nbsp;|&nbsp;&nbsp;
              	<a href="https://www.notm.or.kr/index">개인정보 파파라치 신고센터</a>
              </p>
            </div>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
			<p>Copyright &copy;
				...
				by 
				<a href="https://www.itwill.co.kr/" target="_blank">IT WILL</a>
			</p>
          </div>
        </div>
      </div>
